...
EXEC sp_help 'Atendimento.Cliente';
GO
...
INSERT INTO Atendimento.Cliente(Nome, Endereco, Telefone, CNH)
...
EXEC sp_help 'Atendimento.Veiculo';
GO
...
INSERT INTO Atendimento.Veiculo(Placa, CodCliente, Marca, Modelo, Ano, Renavam)
...
GO
INSERT INTO Atendimento.Veiculo(Placa, Marca, Modelo, Ano, Renavam)
...
EXEC sp_help 'Oficina.Mecanico';
GO

SELECT *
FROM Oficina.Mecanico;
GO

*/

-- Inserindo dados na tabela Mecanico
INSERT INTO Oficina.Mecanico(CREA, Nome, Endereco, Celular, CPF)
...
INSERT INTO Oficina.Revisao(Placa, CREA, DataHoraRevisao, ValorRevisao, Relatorio, TrocaPecas)
	VALUES('EFG5678', '12345', '2014-18-04 10:15', 315.25, 'Revisão geral do auto, troca de óleo e alinhamento', 0);
GO
INSERT INTO Oficina.Revisao(Placa, CREA, DataHoraRevisao, ValorRevisao, Relatorio, TrocaPecas)
	VALUES('BCD2345', '45678', '2014-18-04 08:28', 200.25, 'Alinhamento e balanceamento', 0);
GO
INSERT INTO Oficina.Revisao(Placa, CREA, DataHoraRevisao)
	VALUES('DEF4567', '23456', '2014-18-04 09:42');
GO
INSERT INTO Oficina.Revisao(Placa, CREA, DataHoraRevisao)
	VALUES('CDE3456', '12345', '2014-18-04 15:25');
GO
INSERT INTO Oficina.Revisao(Placa, CREA, DataHoraRevisao)
	VALUES('DEF4567', '34567', '2014-18-04 14:20');
GO

/*

EXEC sp_help 'Oficina.VeiculoPesado';
GO

SELECT *
FROM Oficina.VeiculoPesado;
GO

*/

-- Inserindo dados na tabela VeiculoPesado
INSERT INTO Oficina.VeiculoPesado(Placa, PesoToneladas, NumeroEixos, ComprimentoMetros)
